      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="mt-6 rounded-md bg-blue-50 p-4">
            ...
            <p className="text-xs text-blue-700">Superadmin: superadmin@sportsacademy.com / password123</p>
            <p className="text-xs text-blue-700">Admin: admin@demoacademy.com / password123</p>
            <p className="text-xs text-blue-700">Coach: coach@demoacademy.com / password123</p>
          </div>
        </form>
      </div>
    </div>
